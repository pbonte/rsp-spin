...
public class SPINFactory {
	...
	/**
	 * Attempts to cast a given Resource into an Aggregation. Resources that
	 * have an aggregation type as their rdf:type are recognized as well-formed
	 * aggregations.
	 * 
	 * @param resource
	 *            the Resource to cast
	 * @return the Aggregation or null if Resource is not a well-formed
	 *         aggregation
	 */
	...
	/**
	 * Attempts to cast a given Resource into the most specific subclass of
	 * Command, esp Update or Query.
	 * 
	 * @param resource
	 *            the Resource to cast
	...
	/**
	 * Returns the most specific Java instance for a given RDFNode. If the node
	 * is an aggregation, it will be returned as instance of Aggregation. If the
	 * node is a function call, it will be returned as instance of FunctionCall.
	 * If it's a Variable, the Variable will be returned. Otherwise the node
	...
	/**
	 * Converts a given Resource into a Function instance. No other tests are
	 * done.
	 * 
	 * @param resource
	...
	/**
	 * Checks if a given Resource might represent a Function call, and if yes
	 * returns the resource as Function. The condition here is fairly general: a
	 * function call must be a blank node with an rdf:type triple where the type
	 * triple's object is a URI resource. It is generally assumed that this
	 * function is called after other options have been exhausted. For example,
	 * in order to test whether a resource is a variable or a function call, the
	 * variable test must be done first as it is more specific than these test
	 * conditions
	 * 
	 * @param resource
	...
	/**
	 * Checks if a given Resource is a SPIN query, and returns an instance of a
	 * subclass of Query if so.
	 * 
	 * @param resource
	 *            the Resource to test
	...
	/**
	 * Converts a given Resource into a Template instance. No other tests are
	 * done.
	 * 
	 * @param resource
	 *            the Resource to convert
	...
	/**
	 * Checks whether a given RDFNode can be converted into a TriplePattern, and
	 * if yes, returns an instance of TriplePattern.
	 * 
	 * @param node
	 *            the node to test
	...
	/**
	 * Checks if a given Resource is a subclass of sp:Update and casts it into
	 * the most specific Java class possible.
	 * 
	 * @param resource
	 *            the Resource to cast
	...
	/**
	 * Creates an spl:Argument with a given property and value type. The new
	 * Argument resource will be a blank node in a given Model.
	 * 
	 * @param model
	 *            the Model
	 * @param argProperty
	 ...
	 * @param optional
	 *            true if the Argument shall be optional
	 ...
	 * 
	 * @param model
	 *            the Model to create the attribute in
	 * @param argProperty
	 *            the predicate or null
	 * @param argType
	 *            the value type or null
	 * @param minCount
	 *            the minimum cardinality or null
	 * @param maxCount
	 *            the maximum cardinality or null
	 * @return a new Attribute
	 */
	public static Attribute createAttribute(Model model, Property argProperty, Resource argType, Integer minCount,
			Integer maxCount) {
	 ...
	 * 
	 * @param model
	 *            the Model to create the Ask (blank node) in
	 * @param where
	 ...
	 * 
	 * @param model
	 *            the Model to create the Bind in
	 * @param variable
	 ...
	 * 
	 * @param model
	 *            the Model to create the ElementList in
	 * @param elements
	 *            the elements (may be empty)
	 ...
	 * 
	 * @param model
	 *            the Model to create the EXISTS in
	 * @param elements
	 *            the elements of the EXISTS
	 * @return a new Exists
	 */
	 ...
	 * 
	 * @param model
	 *            the Model to create the (blank node) Filter in
	 * @param expression
	 *            the expression node (not null)
	 * @return a new Filter
	 */
	 ...
	 * 
	 * @param model
	 *            the Model to create the function call in
	 * @param function
	 *            the function class (must be a URI resource)
	 ...
	 * 
	 * @param model
	 *            the Model to create the MINUS in
	 * @param elements
	 *            the elements of the MINUS
	 * @return a new Minus
	 */
	 ...
	 * 
	 * @param model
	 *            the Model to generate the NamedGraph in
	 * @param graphNameNode
	 *            the URI resource of the graph name
	 * @param elements
	 *            the elements in the NamedGraph
	 ...
	 * 
	 * @param model
	 *            the Model to generate the NamedWindow in
	 * @param windowNameNode
	 *            the URI resource of the window name
	 * @param elements
	 *            the elements in the NamedWindow
	 ...
	 * 
	 * @param model
	 *            the Model to create the NOT EXISTS in
	 * @param elements
	 *            the elements of the NOT EXISTS
	 ...
	 * 
	 * @param model
	 *            the Model to create the OPTIONAL in
	 * @param elements
	 *            the elements of the OPTIONAL
	 ...
	 * 
	 * @param model
	 *            the Model to create the SubQuery in
	 * @param subQuery
	 *            the nested query
	 ...
	 * 
	 * @param model
	 *            the Model to create a template call in
	 * @param template
	 *            the template class
	 ...
	 * 
	 * @param model
	 *            the Model to create the path in
	 * @param subject
	 ...
	 * 
	 * @param model
	 *            the Model to create the pattern in
	 * @param subject
	 *            the subject (not null)
	 * @param predicate
	 ...
	 * 
	 * @param model
	 *            the Model to create the Union in
	 * @param elements
	 *            the elements
	 * @return a new Union
	 */
	 ...
	 * 
	 * @param model
	 *            the Model to create the Values in
	 * @param data
	 *            the Table providing the actual data
	 * @return a new Values
	 */
	...
	/**
	 * Gets an spl:Attribute defined for a given property on a given class. The
	 * spl:Attribute must be a direct spin:constraint on the class.
	 * 
	 * @param cls
	 *            the class
	 * @param property
	 ...
	 * Template. For example, for an Ask query, this will return
	 * spin:AskTemplate.
	 * 
	 * @param command
	 *            the Command, cast into the best possible subclass
	...
	/**
	 * Checks if a given Resource can be cast into an ElementList. It must be
	 * either rdf:nil or an rdf:List where the first list item is an element
	 * using <code>asElement()</code>.
	 * 
	 * @param resource
	 *            the resource to test
	...
	/**
	 * Checks if a given Resource is an instance of a class that has type
	 * spin:Module (or its subclasses such as spin:Function).
	 * 
	 * @param resource
	 *            the Resource to check
	 ...
	 * is stricter than for <code>asTemplateCall</code> as the node also must
	 * have a valid template assigned to it, i.e. the type of the node must be
	 * an instance of spin:Template.
	 * 
	 * @param node
	 *            the RDFNode to check
