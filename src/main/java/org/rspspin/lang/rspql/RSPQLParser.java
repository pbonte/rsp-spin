/* Generated By:JavaCC: Do not edit this line. RSPQLParser.java */
...
public class RSPQLParser extends RSPQLParserBase implements RSPQLParserConstants {
  ...
  final public void OutputStreamDecl() throws ParseException {
  Node iri;
    jj_consume_token(REGISTER);
    jj_consume_token(STREAM);
    iri = VarOrIri();
    jj_consume_token(AS);
    getQuery().setOutputstream(iri);
  }

  final public void OutputStreamType() throws ParseException {
  String outOp = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DSTREAM:
      jj_consume_token(DSTREAM);
      getQuery().setQueryDstreamType();
      break;
    case RSTREAM:
      jj_consume_token(RSTREAM);
      getQuery().setQueryRstreamType();
      break;
    case ISTREAM:
      jj_consume_token(ISTREAM);
      getQuery().setQueryIstreamType();
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
  ...
  Node toNode;
    ...
    windowNameNode = VarOrIri();
    jj_consume_token(ON);
    streamNameNode = VarOrIri();
    jj_consume_token(LBRACKET);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case RANGE:
      jj_consume_token(RANGE);
      rangeNode = VarOrDuration();
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case STEP:
        jj_consume_token(STEP);
        stepNode = VarOrDuration();
        break;
      default:
        jj_la1[26] = jj_gen;
        ;
      }
      getQuery().addLogicalWindow(windowNameNode, streamNameNode, rangeNode, stepNode);
      break;
    case ITEM:
      ...
      default:
        ...
        ;
          ...
          getQuery().addPhysicalWindow(windowNameNode, streamNameNode, rangeNode, stepNode);
      break;
    case FROM:
      jj_consume_token(FROM);
      fromNode = VarOrPastDuration();
      jj_consume_token(TO);
      toNode = VarOrPastDuration();
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case STEP:
        jj_consume_token(STEP);
        stepNode = VarOrDuration();
      ...
      getQuery().addLogicalPastWindow(windowNameNode, streamNameNode, fromNode, toNode, stepNode);
      break;
    default:
      jj_la1[29] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Element TriplesBlock(ElementPathBlock acc) throws ParseException {
    if (acc == null) acc = new ElementPathBlock();
  ...
  final public Element WindowGraphPattern() throws ParseException {
  Element el;
  Node n;
    jj_consume_token(WINDOW);
    n = VarOrIri();
    el = GroupGraphPattern();
    {if (true) return new ElementWindowGraph(n, el);}
    // This check does not work for windows defined in the super query...
    //if(getQuery().hasWindowUri(n))
        //  {
        //    return new ElementWindowGraph(n, el);
        //  } else
        //  {
        //    throw new QueryException("Window clause URI not in named window set: " + n);
        //  }
  ...
  ExprList a;
    ...
    {
      if (!allowAggregatesInExpressions) throwParseException("Aggregate expression not legal at this point : " + fname, - 1, - 1);
  ...
  Token t;
    ...
    case LPAREN:
      ...
      case DISTINCT:
        ...
        int beginColumn = t.beginColumn;
        t = null;
        if (!allowAggregatesInExpressions) throwParseException("Aggregate expression not legal at this point", beginLine, beginColumn);
        break;
      default:
        jj_la1[97] = jj_gen;
        ;
  ...
  Node n;
    ...
    case CARAT:
      ...
      case PNAME_LN:
        str = iri();
        n = createNode(str);
        {if (true) return new P_ReverseLink(n);}
        break;
      case KW_A:
        jj_consume_token(KW_A);
  ...
  final public Node VarOrDuration() throws ParseException {
  Node n = null;
  Token t = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VAR1:
    ...
    case DURATION:
      ...
      {if (true) return createLiteral(t.image, "", "http://www.w3.org/2001/XMLSchema#duration");}
      break;
    default:
      jj_la1[138] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Node VarOrPastDuration() throws ParseException {
  Node n = null;
  Token t = null;
  ...
  final public Node VarOrInt() throws ParseException {
  Node n = null;
  Token t = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VAR1:
    ...
    case INTEGER:
      t = jj_consume_token(INTEGER);
      {if (true) return createLiteral(t.image, "", "http://www.w3.org/2001/XMLSchema#int");}
      break;
    default:
      jj_la1[140] = jj_gen;
      jj_consume_token(-1);
  ...
  Node n;
    ...
    while (true) {
      ...
      if (addition) expr1 = new E_Add(expr1, expr2);
  ...
  Token t;
    ...
    if (!allowAggregatesInExpressions) throwParseException("Aggregate expression not legal at this point", t.beginLine, t.beginColumn);
    Expr exprAgg = getQuery().allocAggregate(agg);
    {if (true) return exprAgg;}
    throw new Error("Missing return statement in function");
  }
  ...
  boolean distinct = false;
    ...
    {
      if (!allowAggregatesInExpressions) throwParseException("Aggregate expression not legal at this point : " + iri, - 1, - 1);
  ...
  public RSPQLParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0xe400000,0x200,0x300000,0x300000,0x0,0x0,0x0,0x1800000,0x1800000,0x1c00,0x0,0xdc00,0xdc00,0xdc00,0x0,0x0,0x0,0x0,0xdc00,0xdc00,0x0,0x0,0x0,0x1c00,0x1c00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x30000000,0xdc00,0x0,0xdc00,0x1c00,0xdc00,0x0,0xdc00,0xdc00,0x20000000,0x10000000,0x30000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1c00,0x0,0x1c00,0x0,0xfc00,0x0,0x0,0xfc00,0xfc00,0xfc00,0x0,0x0,0xfc00,0x0,0xfc00,0x0,0x400000,0xfc00,0x0,0x0,0xfc00,0xfc00,0x0,0x0,0x0,0xc000,0x1c00,0xc000,0x0,0x0,0x1c00,0x0,0x1c00,0x0,0x1c00,0x800000,0x0,0x0,0x0,0x0,0x0,0xfc00,0x8dc00,0x0,0x8dc00,0x8dc00,0x0,0xfc00,0x88dc00,0x88dc00,0x0,0x88dc00,0x88dc00,0x0,0x0,0x0,0x0,0x0,0x881c00,0x0,0x0,0x0,0x0,0x881c00,0x0,0x81c00,0x81c00,0x81c00,0x81c00,0x0,0x0,0xfc00,0xfc00,0xfc00,0xfc00,0xfc00,0xc000,0xc000,0xc000,0xdc00,0xfc00,0xc000,0x3c00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xdc00,0xdc00,0x0,0x0,0x0,0x0,0x0,0x0,0x800000,0xdc00,0x800000,0x800000,0x800000,0x800000,0x800000,0x800000,0x0,0x0,0x0,0x800000,0x0,0xdc00,0x0,0x0,0x10000,0x10000,0x0,0x0,0x0,0x0,0x0,0x0,0x1c00,0x1800,0x2000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x40,0x0,0x0,0x0,0x0,0x700,0x10000,0x700,0x0,0x0,0x0,0x10000000,0xc000000,0xc000000,0xc000000,0x700,0x10000,0x10000,0x30000,0x0,0x0,0x10000,0x20000,0x10000,0x10,0x20,0x2000,0x2000,0x2000,0x19000,0x20000,0x20000000,0x40000000,0x0,0x0,0xc000000,0x10000000,0xc000000,0xc000000,0xc00000c,0xc,0xc000000,0xc00000c,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x80000,0x80000,0x80010,0x0,0x80000,0x0,0x0,0x0,0x0,0x80000,0x0,0x0,0x80000,0x0,0x0,0x0,0x0,0xfd80021,0x0,0x0,0x0,0x0,0xfd80021,0x0,0x0,0x2,0x0,0x0,0x0,0x2,0x0,0x2,0x200000,0xc000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000000,0x8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc000000,0xc000000,0x0,0x0,0xc000000,0x0,0x0,0x0,0x0,0xc000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe5edbf,0xffe5edbf,0xffe5edbf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe5edbf,0x0,0xffe5edbf,0xffe5edbf,0xffe5edbf,0x0,0xffe5edbf,0xffe5edbf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200,0x0,0x0,0x0,0x0,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe5edbf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x180000,0x180000,0x0,0x180000,0x180000,0x0,0x0,0x0,0x0,0x0,0x180000,0x0,0x0,0x0,0x0,0x180000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe5edbf,0xffe5edbf,0x0,0x0,0xffe5edbf,0x0,0x0,0x0,0x0,0xffe5edbf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe5edbf,0x1bf,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffffff,0xffffffff,0xffffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffffff,0x0,0xffffffff,0xffffffff,0xffffffff,0x0,0xffffffff,0xffffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffffff,0xffffffff,0x0,0x0,0xffffffff,0x0,0x0,0x0,0x0,0xffffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe0000060,0x0,0xe000007d,0xe000007d,0xe000007d,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1d,0x0,0x1d,0x1d,0x1d,0x0,0x1d,0x1d,0x0,0x0,0x0,0x0,0x0,0x427ff00,0x427ff00,0x100000,0x400000,0x100000,0x100000,0x100000,0x100000,0x100000,0x100000,0x4000000,0x100,0x300,0x8000000,0x0,0x0,0x1000000,0x3000000,0xe0000060,0x0,0x0,0xe0000060,0xe0000060,0xe0000060,0x0,0x0,0xe0000060,0x0,0xe0000060,0x0,0x0,0xe0000060,0x0,0x0,0xe0000060,0xe0000060,0x0,0x0,0x100000,0x0,0xe0000060,0x0,0x0,0x0,0xe0000060,0x0,0xe0000060,0x0,0x1d,0x0,0x0,0x0,0x0,0x0,0x0,0xe0000060,0x0,0x0,0x0,0x0,0x0,0xe0000060,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe0000060,0xe0000060,0xe0000060,0xe0000060,0xe0000060,0x0,0x0,0x20000000,0x0,0x0,0x0,0xe0000060,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe000007d,0xe000007d,0x0,0x0,0x1d,0x0,0x0,0x0,0x0,0xe000007d,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe000007d,0x0,0x0,0x0,0x0,0xe0000000,0xe0000000,0x0,0x0,0x60,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c3f,0x0,0x7c3f,0x7c3f,0x7c3f,0x0,0x0,0x0,0x20000,0x0,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0x0,0x4000,0x4000,0x4000,0x0,0x4000,0x4000,0x0,0x0,0x0,0x0,0x400000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x297c3f,0x0,0x1000000,0x297c3f,0x297c3f,0x297c3f,0x20000,0x1000000,0x297c3f,0x0,0x297c3f,0x1000000,0x0,0x297c3f,0x20000,0x1000000,0x297c3f,0x297c3f,0x1000000,0x20000,0x0,0x14000,0x3c3f,0x0,0x14000,0x14000,0x3c3f,0x14000,0x3c3f,0x0,0x4000,0x0,0x800000,0x14000,0x800000,0x14000,0x1000000,0x297c3f,0x0,0x400000,0x0,0x0,0x800000,0x297c3f,0x80004000,0x80004000,0x400000,0x80004000,0x80004000,0x800000,0x0,0x0,0x0,0x20000,0x80004000,0x40000,0x840000,0x800000,0x20000,0x80004000,0x0,0x0,0x4000,0x0,0x0,0x84000,0x84000,0x297c3f,0x297c3f,0x297c3f,0x297c3f,0x213c3f,0x0,0x0,0x0,0x0,0x200000,0x0,0x213c3f,0x0,0x0,0x7e000000,0x7e000000,0x3f,0x3f,0x0,0x0,0x3f,0x0,0x0,0x80007c3f,0x7c3f,0x14000,0x800000,0x0,0x800000,0x800000,0x800000,0x0,0x80007c3f,0x0,0x0,0x0,0x0,0x0,0x0,0x400000,0x400000,0x400000,0x0,0x800000,0x80007c3f,0x0,0x14000,0x0,0x0,0x3f,0x0,0x7,0x38,0x0,0x3c00,0x0,0x0,0x200000,};
   }
   private static void jj_la1_init_6() {
      jj_la1_6 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000,0x1000,0x0,0x1000,0x1000,0x0,0x800,0x1080,0x1080,0x8050,0x1000,0x0,0x0,0x50,0x8050,0x0,0x800,0x1000,0x1000,0x0,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x8,0x0,0x0,0x30,0x0,0xc0,0xc0,0x30,0xc0,0xc0,0x30,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x70,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x30,0x0,0x0,0x100,0x100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
  ...
  public RSPQLParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public RSPQLParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new RSPQLParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public RSPQLParser(java.io.Reader stream) {
  ...
  public RSPQLParser(RSPQLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(RSPQLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
