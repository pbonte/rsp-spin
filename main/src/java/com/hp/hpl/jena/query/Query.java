...
public class Query extends Prologue implements Cloneable, Printable {
	...
	/**
	 * Set whether the query had SELECT/DESCRIBE * Strictly, this just means
	 ...
	 * QueryEngine will attempt to load the data from these URIs into the
	 * default (unamed) graph.
	 */
	...
	/**
	 * Location of the source for the data. If the model is not set, then the
	 * QueryEngine will attempt to load the data from these URIs as named graphs
	 * in the dataset.
	 */
	...
	/**
	 * Test whether the query mentions a URI in forming the default graph (FROM
	 * clause)
	 * 
	 * @param uri
	...
	/**
	 * Return the list of URIs (strings) for the named graphs (FROM NAMED
	 * clause)
	 * 
	 * @return List of strings
	 */
	 ...
	 * @return
	 */
	public List<ElementNamedWindow> getNamedWindows() {
		return namedWindows;
	}
	...
	/**
	 * Return true if the query has either some graph URIs or some named graph
	 * URIs in its description. This does not mean these URIs will be used -
	 * just that they are noted as part of the query.
	 */
	...
	protected List<Expr> havingExprs = new ArrayList<Expr>(); // Expressions :
																// Make an
																// ExprList?
	...
	/**
	 * Get the result list (things wanted - not the results themselves) of a
	 * DESCRIBE query.
	 */
	...
	/**
	 * Fix up when the query has "*" (when SELECT * or DESCRIBE *) and for a
	 * construct query. This operation is idempotent.
	 */
	...
	/**
	 * Are two queries equals - tests shape and details. Equality means that the
	 * queries do the same thing, including same variables, in the same places.
	 * Being unequals does <b>not</b> mean the queries do different things.
	 * 
	 * For example, reordering a group or union means that that a query is
	 * different.
	 * 
	...
	/**
	 * Format the query into the buffert
	 * 
	 * @param buff
	 *            IndentedLineBuffer
	 */
	...
	private List<ElementNamedWindow> namedWindows = new ArrayList<>();
	protected String streamType = null;
	private Node registerAs = null;

	/**
	 * Add a named window (logical or physical)
	 * 
	 * @param uri
	 */
	...
	/**
	 * Set reference IRI to the stream that is generated by the query
	 * 
	 * @param name
	 */
	public void setRegisterAs(Node name) {
		registerAs = name;
	}

	/**
	 * Set stream type as Istream
	 */
	...
	/**
	 * Get reference IRI to the stream that is generated by the query
	 * @return
	 */
